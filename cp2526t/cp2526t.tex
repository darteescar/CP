...
Depois de analisarmos os três componentes principais desta solução — o mónade \ensuremath{\fun{Dist}}, o comportamento encapsulado pelo \ensuremath{\Varid{gene}} e o catamorfismo \ensuremath{\Varid{pcataList}} —, a definição do \ensuremath{\Varid{gene}} torna-se natural.
...
\item Para o caso da lista não ser vazia (\ensuremath{i_2\;(\Varid{x},\Varid{y})}), cada palavra $x$ tem uma probabilidade de 95\% de ser transmitida, enquanto os restantes 5\% representam a perda da palavra.
